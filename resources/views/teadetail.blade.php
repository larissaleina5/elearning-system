								...
								<div class="d-flex justify-content-between">
									<div class="user">
										<div class="user-media">
											<img src="images/avatar/8.jpg" alt="" class="avatar avatar-xxl">
										</div>
										<div>
											<h2 class="mb-0">Maria Historia</h2>
											<p  class="text-primary font-w600">History Teacher</p>
										</div>
									</div>
						...
						<div  class="'col-xl-12">
							<div class="card">
								<div class="card-body">
									...
									<ul>
										<li class="dots">
											<h6 class="mb-1">History Major, University Akademi Historia</h6>
											<span>2013-2017</span>
										</li>
										<li class="dots">
									...
									<h3 class="heading mt-4">Expertise:</h3>
