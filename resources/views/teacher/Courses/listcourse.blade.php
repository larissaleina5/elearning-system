                    ...
                    <div class="col-xl-12">
                        <div class="page-title flex-wrap">
                            ...
                            <div>
                                ...
                                <a href="{{ route('teach.createcourse') }}" class="btn btn-primary">New Course</a>
                                <
                            </button>
                            </div>
                        </div>
                            ...
                            <table class="table-responsive-lg table display dataTablesCard student-tab dataTable no-footer" id="example-student">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-primary font-w600">{{ $course->course_description }}</span>
                                        </td>
                                        <td>
                                            <div class="date">{{ $course->level }}</div>
                                        </td>
                                        <td>
                                            <div class="date">{{ $course->status }}</div>
                                        </td>
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <form id="delete-course" action="{{route('delete.courses',$course->id) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
