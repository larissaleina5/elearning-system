                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <form id="delete-course" action="{{route('delete.courses',$lesson->id) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')

                                                </form>
                                                <a class="btn btn-primary" href="{{ route('teacher.create.lessons',$lesson->id) }}">Crearte Lesson</a>
                                            </div>
                                        </td>
