                            ...
                            <table class="table-responsive-lg table display dataTablesCard student-tab dataTable no-footer" id="example-student">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-primary font-w600">{{ $category->email }}</span>
                                        </td>
                                        <td>
                                            <div class="date">{{ $category->phone }}</div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a onclick="event.preventDefault();document.getElementById('delete-user').submit()">
                                                ...
                                                <form id="delete-user" action="{{ route('delete.student',$student->id) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
